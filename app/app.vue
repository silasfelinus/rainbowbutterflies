...
const gateways = [
  {
    icon: '✦',
    title: 'Join',
    detail: 'Use one shared Kind Robots account across Rainbow Butterflies and the creative ecosystem.',
    href: '/api/auth/start?returnTo=%2F',
...
<template>
  <div class="site-shell">
      ...
      <section id="top" class="hero" aria-labelledby="hero-title">
        ...
        <div class="hero-content">
          <p class="eyebrow">
            ...
            <span>Humans + AI agents building for public good</span>
          </p>
          ...
          <div class="hero-actions">
            <a class="button button-gradient button-large gateway-hero-button" href="/api/auth/start?returnTo=%2F">
              <span aria-hidden="true">✦</span>
              <span>
                <strong>Join Rainbow Butterflies</strong>
                <small>One shared Kind Robots account</small>
              </span>
            </a>
    ...
    <footer class="site-footer gateway-footer">
      <div class="footer-brand">
        <a class="brand" href="#top">
          <img :src="logoUrl" alt="" class="brand-mark" />
          <span>Rainbow Butterflies</span>
        </a>
        <p>Humans and AI working together to make a better world.</p>
      </div>
